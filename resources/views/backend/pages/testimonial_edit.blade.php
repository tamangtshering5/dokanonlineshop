                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col col-xs-6">
                                        <h3 class="panel-title">Testimonial Edit</h3>
                                    </div>
                                    <div class="col col-xs-6 text-right">
                                        <a href="{{route('admin_testimonial')}}" class="btn btn-sm btn-primary btn-create"><i class="fa fa-reply"></i>Back</a>
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-label-left" method="post" id="tour_form"
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <div>
                                            <input type="text" name="designation" value="{{$datas->designation}}"  class="form-control" >
                                        </div>
                                    </div>
