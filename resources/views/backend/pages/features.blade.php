                                ...
                                <table class="table table-striped table-bordered table-list">
                                    ...
                                    @foreach($datas as $data)
                                        <tr>
                                            ...
                                            <td>{!! $data->detail !!}</td>
                                            <td algn="center">
                                                <a href="{{route('feature_edit',['id'=>$data->id])}}" class="btn btn-success"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal form-label-left" method="post" id="tour_form"
                                            ...
                                            <div class="form-group col-lg-6">
                                                <label for="category">Designation <span class="required" style="color:red;">*</span> </label>
                                                <div>
