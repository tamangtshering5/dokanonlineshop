                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" method="post"
                                  action="{{route('admin-product-submenu-action')}}" enctype="multipart/form-data">
                                {{csrf_field()}}
                               ...
                               <div class="row">
                                   <div class="form-group col-md-4 col-sm-6 col-lg-6">
                                   ...
                                   <div class="form-group col-md-4 col-sm-6 col-lg-6">
                                       <label for="category">Product_Code:  </label>
                                       <div>
