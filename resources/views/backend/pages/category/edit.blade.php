                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" method="post"
                              action="{{route('admin-category-update',['id'=>$datas->id])}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="name" name="category" value="{{$datas->category}}" required  class="form-control">
                                </div>
                            </div>
