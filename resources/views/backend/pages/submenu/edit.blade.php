        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-6">
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        <h2><i class="fa fa-tag"></i>&nbsp; Edit SubMenu </h2>
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" method="post"
                              action="{{route('admin-submenu-update',['id'=>$datas->id])}}" enctype="multipart/form-data">
                            ...
                            {{--<div class="form-group">
                                ...
                                @foreach(App\Model\Menu::where('id','=',$datas->menu_id)->get() as $menu)
                                <div>
                                    <input type="text" id="name" name="menu" value="{{$menu->menu}}" required  class="form-control">
                                </div>
                                    @endforeach
                            </div>--}}
                            ...
                            <div class="form-group">
                                <label for="category">Menu <span class="required">*</span> </label>
                                <div>
                                    <select name="menu_id" id="menu" required class="form-control">
                                        @foreach(App\Model\Menu::where('id','=',$datas->menu_id)->get() as $menu)
                            ...
                            <div class="form-group">
                                <label for="category">Sub Menu <span class="required">*</span> </label>
                                    <div>
                                        <input type="text" id="title" name="title" value="{{$datas->title}}" required  class="form-control">
                                    </div>
                            </div>
