...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <hr />
            <div class="ttl-amts">
                <h3 class="text-primary"> <strong>Bill Amount :Rs. {{(Cart::total())}}</strong> </h3>
            </div>
    ...
    <div class="row pad-top-botm">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            &nbsp;&nbsp;&nbsp;
            <a href="{{route('download_invoice')}}" class="btn btn-primary btn-lg" style="width: 170px; height: 50px; font-size:20px; line-height: 35px;" >Download PDF</a>
            <a href="{{route('continue')}}" class="btn btn-primary btn-lg" style="width: 170px; height: 50px; font-size:20px; line-height: 35px;" >Go Back</a>
        </div>
    </div>
