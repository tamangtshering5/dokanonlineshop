...
@section('body')
    ...
    <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
        <div class="more-info-tab clearfix ">
            <h3 class="new-product-title pull-left">Latest Offer Products</h3>
            ...
            <div class="tab-pane in active" id="all">
                <div class="product-slider">
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                        @foreach($alloffer->chunk(2) as $offers)
                        <div class="item item-carousel">
                            @foreach($offers as $offer)
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image"> <a href="{{route('product_details',['slug'=>$offer->slug])}}"><img src="{{URL::to('backend/images/products/'.$offer->image)}}" alt=""></a> </div>
                                        <!-- /.image -->
                                        @if($offer->discount != null)
                                        <div class="tag new"><span><small>{{$offer->discount}}% off</small></span></div>
                                            @endif
                                    </div>
                                    <!-- /.product-image -->

                                    <div class="product-info text-left">
                                        <h3 class="name"><a href="{{route('product_details',['slug'=>$offer->slug])}}">{{$offer->product_name}}</a></h3>
                                        ...
                                        <div class="product-price"> <span class="price"> Rs.{{$offer->new_price}} </span><span class="price-before-discount">Rs.{{$offer->old_price}}</span></div>
                                        <!-- /.product-price -->
                                        ...
                                        <div class="action">
                                            <ul class="list-unstyled">
                                                <li class="add-cart-button btn-group" style="margin-left: -10px;">
                                                    <a href="{{route('addcart',['slug'=>$offer->slug])}}"><button class="btn btn-primary icon" type="button">Add to cart <i class="fa fa-shopping-cart"></i> </button></a>
                            ...
                            <div class="products">
                                <div class="product">
                                    ...
                                    <div class="cart clearfix animate-effect">
                                        <div class="action">
                                            <ul class="list-unstyled">
                                                <li class="add-cart-button btn-group" style="margin-left: 50px;">
                                                    <a href="{{route('addcart',['slug'=>$product->slug])}}"><button class="btn btn-primary icon" type="button"> <i class="fa fa-shopping-cart"></i> </button></a>
                                                    <button class="btn btn-primary cart-btn" type="button"></button>
                                                </li>
                                            </ul>
                                        </div>
