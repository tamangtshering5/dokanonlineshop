...
<div class="body-content outer-top-xs">
    <div class='container'>
        <div class='row'>
            <div class='col-md-12'>
                <div class="page-title"><h2>{{$catlink->category}}/{{$menulink->menu}}</h2></div>
                                        ...
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="{{route('product_details',['slug'=>$subprod->slug])}}"><img src="{{URL::to('backend/images/products/'.$subprod->image)}}" alt="" style="height:195px;"></a> </div>
                                                    <!-- /.image -->
                                        ...
                                        <div class="product-list product">
                                            <div class="row product-list-row">
                                                <div class="col col-sm-4 col-lg-4">
                                                    <div class="product-image">
                                                    <div class="image" style="height:150px;"> <img src="{{URL::to('backend/images/products/'.$subprod->image)}}" alt=""></div>
                                                    </div>
                                                    <!-- /.product-image -->
                                                </div>
                                                <!-- /.col -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="wide-banner cnt-strip">
                                <div class="image"> <a href="{{$adv->url}}"><img class="img-responsive" src="{{URL::to('backend/images/advertisement/'.$adv->image)}}" alt="" style="height:150px;width:600px;"></a> </div>
                            </div>
                            <!-- /.wide-banner -->
                        </div>
                        @endforeach
